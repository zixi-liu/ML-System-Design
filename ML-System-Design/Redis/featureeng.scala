// Redis example for feature eng https://github.com/wzhe06/SparrowRecSys/blob/master/src/main/java/com/sparrowrecsys/offline/spark/embedding/Embedding.scala
